var dataController = (function() {
    ...
    return {
        ...
        saveItem: function(img, city) {
            var newItem;

            newItem = new SaveItem(img, city);

            data.save.push(newItem);
...
var UIController = (function() {
    ...
    var DOMstrings = {
        ...
        cityLabel: '#name_city',
        imageLabel: '#img_city',
        saveItemContainer: '.save_list'
    };

    var displayCityImage = function(num) {
        document.querySelector(DOMstrings.imageLabel).style.visibility = 'visible';
        document.querySelector(DOMstrings.img).src = "img/" + num + ".gif";
    };

    var displayCityName = function (city) {
        document.querySelector(DOMstrings.cityLabel).style.visibility = 'visible';
    ...
    return {
        ...
        addSaveItem: function(obj) {
            var html, newHTML;
            // create html string with placeholder
            html = '<li class="save_item-%order%"><img src="img/%number%.gif" alt="Location %order%" class="save_img"><div class="save_item_text">%cityname%</div><div class="save_item_check_box"><input type="checkbox" class="save_item_check"></div></li>';
            //replace placeholder text with data
            newHTML = html.replace('%number%', obj.img);
            newHTML = newHTML.replace('%cityname%', obj.en);
            //insert HTML into DOM
            document.querySelector(DOMstrings.saveItemContainer).insertAdjacentHTML('beforeend', newHTML);
        }
    };
...
var controller = (function(dataCtrl, UICtrl) {
    ...
    var randomCity = function() {
        ...
        // add item to save list data structure
        
        
        var newItem = dataCtrl.saveItem(num, city);
        // Update UI
        return newItem
    };
